...
const ICONS: { [key: string]: React.ReactNode } = {
  ...
  tiktok: <g transform="translate(4, 3) scale(0.95)"><path d="M9 0h1.98c.144 2.08 1.54 3.42 3.66 3.62v2.1c-1.18-.04-2.28-.4-3.14-1V12.1c0 4.04-3.4 7.28-7.54 7.28S-3.58 16.14-3.58 12.1-1.04 4.86 3.1 4.86v2.24c-2.4.06-4.52 1.62-4.52 4.2 0 2.54 1.88 4.72 4.54 4.72 2.66 0 4.46-2.18 4.46-4.72V0z" /></g>,
